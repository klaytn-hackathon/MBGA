...
var unitKlayMap = {
  ...
  // eslint-disable-line
  'GKLAY': '1000000000000000000000000000' // eslint-disable-line
...
var unitKlayToEthMap = {
  ...
  'MKLAY': 'mether',
  // eslint-disable-line
  'GKLAY': 'gether' // eslint-disable-line
...
var toChecksumAddress = function (address) {
  ...
  if (!/^(0x)?[0-9a-f]{40}$/i.test(address)) throw new Error('Given address "' + address + '" is not a valid Klaytn address.');
